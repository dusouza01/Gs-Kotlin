package com.example.eduardo94251.viewmodel
...
import com.example.eduardo94251.data.ItemDao
import com.example.eduardo94251.data.ItemDatabase
import com.example.eduardo94251.model.ItemModel
...
class ItemsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun addItem(item: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val newItem = ItemModel(titulo = item, descricao = item)
